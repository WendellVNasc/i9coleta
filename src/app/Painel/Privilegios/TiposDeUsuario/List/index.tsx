...
const TiposDeUsuarioList = ({ type, path, permission } : PageDefaultProps ) => {
    ...
    const column = [
        { title: 'Nome', dataIndex: 'NAME', table: 'credential_type.NAME', width: 'auto', sorter: true, align: 'left', render: null },
        { title: 'Visível', dataIndex: 'VISIBLE_NAME', table: 'credential_type.VISIBLE', width: '100px', sorter: true, align: 'center', render: null },
                ...
                <Col md={24} xs={24}>
                    <CardItem>
                        <Table
                            ...
                            action={action}
                            useFilter={[
                                { type: 'select', name: 'VISIBLE', label: 'Visível', items: [ { label: 'Sim', value: 'Y' }, { label: 'Não', value: 'N' } ] }
                            ]}
                        />
                    </CardItem>
                </Col>
...
export default TiposDeUsuarioList;