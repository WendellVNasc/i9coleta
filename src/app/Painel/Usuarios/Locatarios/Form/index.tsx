...
// SERVIÇOS
import { MaskCEP, MaskCNPJ, MaskCPF, POST_API, POST_CATCH, PageDefaultProps, getToken } from "../../../../../services"
                                        ...
                                        <>
                                            ...
                                            <Col xs={24} md={4}>
                                                <Form.Item name="RESPONSIBLE_CPF" label="Resp. - CPF">
                                                    <Input placeholder="Resp. - CPF" onKeyDown={MaskCPF} maxLength={14} />
                                                </Form.Item>
                                            </Col>
                                            <Col xs={24} md={6}>
                                            ...
                                            <Col xs={24} md={6}>
                                                <Form.Item name="RESPONSIBLE_DEPARTAMENT" label="Resp. - Departamento">
