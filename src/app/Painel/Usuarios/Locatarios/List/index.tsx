...
const LocatariosList = ({ type, path, permission } : PageDefaultProps ) => {
    ...
    const column = [
        { title: 'Foto', dataIndex: 'PHOTO', table: 'credential.PHOTO', width: '60px', sorter: false, align: 'center', render: (item:any) => <Row justify={'center'} style={{width: '100%'}}><Avatar src={item.PHOTO ? item.PHOTO : null} /></Row> },
        ...
        { title: 'Estado', dataIndex: 'STATE_ACRONYM', table: 'state.ACRONYM', width: '80px', sorter: true, align: 'center', render: null },
