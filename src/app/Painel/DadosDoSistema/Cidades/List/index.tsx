...
const CidadeList = ({ type, path, permission } : PageDefaultProps ) => {
    ...
    const column = [
        { title: 'Nome', dataIndex: 'NAME', table: 'city.NAME', width: 'auto', sorter: true, align: 'left', render: null },
        { title: 'Estado', dataIndex: 'STATE_NAME', table: 'state.ACRONYM', width: '150px', sorter: true, align: 'left', render: null },
        { title: 'IBGE', dataIndex: 'IBGE_ID', table: 'city.IBGE_ID', width: '100px', sorter: true, align: 'center', render: null },
