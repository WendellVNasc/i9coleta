...
const EstadosList = ({ type, path, permission } : PageDefaultProps ) => {
    ...
    const column = [
        { title: 'Sigla', dataIndex: 'ACRONYM', table: 'state.ACRONYM', width: '80px', sorter: true, align: 'center', render: null },
        { title: 'Nome', dataIndex: 'NAME', table: 'state.NAME', width: 'auto', sorter: true, align: 'left', render: null },
        { title: 'IBGE', dataIndex: 'IBGE_ID', table: 'state.IBGE_ID', width: '100px', sorter: true, align: 'center', render: null },
