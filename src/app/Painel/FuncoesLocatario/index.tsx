...
const PedirCacamba = () => {
  ...
  return (
    <PageDefault valid={true} items={[{ title: "Pedir Caçamba" }]}>
      <Row gutter={[16, 16]}>
        <Col md={24} xs={24}>
          {load ? (
            <LoadItem />
            ...
            <Row gutter={[16, 16]}>
              <Col span={24}>
                <CardItem>
                  <Input
                    ...
                    size="large"
                    placeholder="Buscar em todo o i9Coleta"
                  />
                </CardItem>
              </Col>
              <Col span={24}>
              ...
              <Col xs={24} md={24}>
                <CardItem>
                  <Row gutter={[16, 16]}>
                    <Col span={12}>
                      <div
                        className="pd-painel externo"
                        onClick={() =>
                          navigate("/painel/pedircacamba/tipolocacao/E")
                        }
                      >
                        <div className="pd-painel-pele"></div>{" "}
                    ...
                    <Col span={12}>
                      <div
                        className="pd-painel interno"
                        onClick={() =>
                          navigate("/painel/pedircacamba/tipolocacao/I")
                        }
                      >
                        <div className="pd-painel-pele"></div>{" "}
                        <Typography className="pd-painel-texto">
              ...
              <Col span={24}>
                <CardItem title="Melhores avaliações">
                  <Button type="link" className="pd-button-card">
                    Ver mais
                  </Button>
                  <Row gutter={[16, 16]}>
